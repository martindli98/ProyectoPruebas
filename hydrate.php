                ...
                <div class="card text-center border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted" style="font-size: 16px">
                            Laminas/Hydrator permite transformar datos entre objetos y arrays de manera eficiente. Puedes convertir un objeto en un array de datos con una simple función.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <img src="hydrateee.png" class="card-img-top" alt="Hydrator Ejemplo 1" style="height: 200px; width: 368px;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted" style="font-size: 16px">
                            Con Hydrator, puedes llenar objetos a partir de un array de datos, facilitando la manipulación de datos en tu aplicación.
                        </p>
                    </div>
                </div>
            </div>
